...
def novo_arquivo(novo_arquivo,header,data):
    try:
        with open(novo_arquivo, mode= 'w',newline='')as arquivo:
...
def main():
    ...
    try:
        ...
        print(f'Coluna {column_index} não encontrada no arquivo csv')
    ...
    if media is not None:
        ...
        print(f'Resultado foram escritos em {output_file}')
